...
@sys.description('The name of the existing resource group where the resources will be deployed.')
...
module networkingModule 'modules/deployInfrastructure.bicep' = {
  ...
  scope: resourceGroup(parResourceGroupName)  // Pass the resource group name as a parameter
  params: {
